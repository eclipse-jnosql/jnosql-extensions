...
/**
 * Builder for creating {@link DeleteOperation} instances outside a CDI container.
 *
 * <p>
 ...
 * @see DeleteOperation
 */
public interface CoreDeleteOperationBuilder {

    /**
     * Creates a new {@link DeleteOperation} instance.
     *
     * @return a new {@link DeleteOperation} instance
     */
    static DeleteOperation build() {
        return new CoreDeleteOperation();
    }
}