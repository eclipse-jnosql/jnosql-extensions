...
/**
 * Step builder for creating {@link DeleteByOperation} instances outside a CDI container.
 *
 * <p>
 * Usage example:
 *
 * <pre>{@code
 * DeleteByOperation operation = SemistructuredDeleteByOperationBuilder.builder()
...
public sealed interface SemistructuredDeleteByOperationBuilder
    ...
    record Step1(SemistructuredQueryBuilder queryBuilder) implements SemistructuredDeleteByOperationBuilder {
        ...
        public DeleteByOperation build() {
            Objects.requireNonNull(queryBuilder, "queryBuilder is required");
            return new SemistructuredDeleteByOperation(queryBuilder);
        }
    }
}