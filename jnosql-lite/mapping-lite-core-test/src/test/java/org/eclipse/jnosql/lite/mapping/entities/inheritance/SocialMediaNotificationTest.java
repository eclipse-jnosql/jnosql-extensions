...
public class SocialMediaNotificationTest {
    ...
    public void setUp() {
        ...
        entityMetadata = mappings.get(SocialMediaNotification.class);
    }

    @Nested
    @DisplayName("When the social media notification metadata is inspected")
    class WhenTheSocialMediaNotificationMetadataIsInspected {
        ...
        void shouldExposeEntitySimpleName() {
            assertThat(entityMetadata.simpleName()).as("value of entityMetadata.simpleName()").isEqualTo(SocialMediaNotification.class.getSimpleName());
        }
        ...
        void shouldExposeEntityClassName() {
            assertThat(entityMetadata.className()).as("value of entityMetadata.className()").isEqualTo(SocialMediaNotification.class.getName());
        }
        ...
        void shouldExposeEntityType() {
            assertThat(entityMetadata.type()).as("value of entityMetadata.type()").isEqualTo(SocialMediaNotification.class);
        }
        ...
        void shouldCreateNewInstance() {
            ...
            SoftAssertions.assertSoftly(soft -> {
                ...
                soft.assertThat(notification).as("value of notification").isInstanceOf(SocialMediaNotification.class);
            });
        }
        ...
        void shouldExposeMappedFieldNames() {
            ...
            SoftAssertions.assertSoftly(soft -> {
                ...
                soft.assertThat(fields.contains("nickname")).as("value of fields.contains(\"nickname\")").isTrue();
            });
        }
        ...
        void shouldGetInheritanceMetadata() {
            InheritanceMetadata inheritance = entityMetadata.inheritance()
                    .orElseThrow();
            SoftAssertions.assertSoftly(soft -> {
                soft.assertThat(inheritance.discriminatorValue()).as("value of inheritance.discriminatorValue()").isEqualTo("SocialMediaNotification");
                ...
                soft.assertThat(inheritance.entity()).as("value of inheritance.entity()").isEqualTo(SocialMediaNotification.class);
