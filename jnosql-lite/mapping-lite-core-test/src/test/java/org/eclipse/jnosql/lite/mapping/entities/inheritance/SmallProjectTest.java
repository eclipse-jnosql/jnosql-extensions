...
public class SmallProjectTest {
    ...
    public void setUp() {
        ...
        entityMetadata = mappings.get(SmallProject.class);
    }

    @Nested
    @DisplayName("When the small project metadata is inspected")
    class WhenTheSmallProjectMetadataIsInspected {
        ...
        void shouldExposeEntitySimpleName() {
            assertThat(entityMetadata.simpleName()).as("value of entityMetadata.simpleName()").isEqualTo(SmallProject.class.getSimpleName());
        }
        ...
        void shouldExposeEntityClassName() {
            assertThat(entityMetadata.className()).as("value of entityMetadata.className()").isEqualTo(SmallProject.class.getName());
        }
        ...
        void shouldExposeEntityType() {
            assertThat(entityMetadata.type()).as("value of entityMetadata.type()").isEqualTo(SmallProject.class);
        }
        ...
        void shouldCreateNewInstance() {
            ...
            SoftAssertions.assertSoftly(soft -> {
                ...
                soft.assertThat(project).as("value of project").isInstanceOf(SmallProject.class);
            });
        }
        ...
        void shouldExposeMappedFieldNames() {
            ...
            SoftAssertions.assertSoftly(soft -> {
                ...
                soft.assertThat(fields.contains("investor")).as("value of fields.contains(\"investor\")").isTrue();
            });
        }
        ...
        void shouldIndexMappedFieldsByName() {
            ...
            SoftAssertions.assertSoftly(soft -> {
                ...
                soft.assertThat(groupByName.get("investor")).as("value of groupByName.get(\"investor\")").isNotNull();
            });
        }
        ...
        void shouldGetInheritanceMetadata() {
            InheritanceMetadata inheritance = entityMetadata.inheritance()
                    .orElseThrow();
            SoftAssertions.assertSoftly(soft -> {
                soft.assertThat(inheritance.discriminatorValue()).as("value of inheritance.discriminatorValue()").isEqualTo("Small");
                soft.assertThat(inheritance.discriminatorColumn()).as("value of inheritance.discriminatorColumn()").isEqualTo("size");
                soft.assertThat(inheritance.entity()).as("value of inheritance.entity()").isEqualTo(SmallProject.class);
