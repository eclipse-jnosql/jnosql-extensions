...
class SqlReturnType {
    ...
    protected Object executeFindByQuery(RepositoryInvocationContext context, SelectQuery query) {
        ...
        DynamicReturn<?> dynamicReturn = DynamicReturn.builder()
                ...
                .streamPagination(streamPagination(query, template, method, entityMetadata))
                .singleResultPagination(getSingleResult(query, template, method, entityMetadata))
                .page(getPage(query, template, method, entityMetadata))
                .build();
