...
- Add Time Series database support to JNoSQL Lite.

=== Fixed

- Fix equality handling for non-comparable values.

== 1.1.17 - 2026-10-29

=== Fixed

* Fixed `Page.totalElements` access outside an active transaction.

=== Changed

* Updated license headers to Eclipse Public License 2.0.
...
- Include the Jakarta Persistence Driver API
